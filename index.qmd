...
La implementación de una arquitectura de Deep Learning basada en redes recurrentes (LSTM) bajo un enfoque secuencial *Many-to-One*, superará significativamente el desempeño de los modelos de referencia simples (modelo bases o calendarios estáticos) en la clasificación de la fase del ciclo menstrual. Esta arquitectura será capaz de capturar las dependencias temporales a largo plazo y extraer relaciones ocultas en ciclos irregulares y ruidosos, donde los algoritmos tradicionales fallan.

## Objetivos {.smaller}

**Objetivo general:** Proponer y diseñar una arquitectura de Deep Learning ideal para el procesamiento de series temporales fisiológicas, con el fin de clasificar la fase biológica del ciclo menstrual en usuarias con patrones regulares e irregulares.

**Objetivos específicos:**

- Modelar el problema como una tarea de clasificación de secuencias temporales mediante un enfoque Many-to-One (Muchos a Uno).

- Preprocesar la base de datos mediante técnicas de imputación que mantengan la estructura y la dependencia temporal de los registros con valores faltantes.

- Diseñar una arquitectura de Deep Learning que integre memoria a largo plazo (como las LSTM) para procesar la naturaleza secuencial de los historiales menstruales.

- Configurar un entrenamiento robusto que incorpore técnicas de regularización, como la *Early Stopping*, para prevenir el sobreajuste.

- Establecer un marco de evaluación que compare el desempeño de la red neuronal contra modelos de referencia utilizando métricas para clasificación, como la matriz de confusión y F1-Score.
...
- **Fase 1**: Definición del problema.
   ...
   - Aquitectura objetivo. [@plaza2025deeplearning]
...
- **Fase 4**: Entrenamiento.
   - Función de coste.
   - Optimización.
   - Prevención del sobreajuste. [@plaza2025deeplearning]

- **Fase 5**: Evaluación y modelos de referencia.
   - Modelos bases. [@plaza2025deeplearning]
   - Métricas.
...
- Se evidencia que los métodos tradicionales son insuficientes para abordar la naturaleza variable del ciclo menstrual.

- Al formular el problema orientado a las secuencias temporables, la metodología de Deep Learning propuesta, nos entrega las herramientas exactas para resolverlo.

- La capacidad de una red como las LSTM para aprender representaciones a partir de datos ruidosos, sumada a un entrenamiento con validación estricta, nos asegura que estamos construyendo una solución computacionalmente robusta, y con un impacto directo en la monitorización de la salud reproductiva.
